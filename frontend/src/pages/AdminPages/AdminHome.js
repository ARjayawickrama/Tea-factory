...
function AdminHome() {
    ...
    const fetchData = async () => {
        try {
            ...
            setFilteredContacts(contactsResponse.data.contacts || contactsResponse.data);
            setError(null);
        } catch (error) {
            ...
            {error ? (
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-7 gap-4 w-full ml-60 max-w-6xl'>
                    ...
                    <div className='bg-white p-4 rounded-lg shadow text-center flex flex-col items-center justify-center'>
                        ...
                        <a href='/Usermanagement' className="text-2xl font-bold">Total Users: {userCount}</a>
                    ...
                    {/* Additional Cards */}
                    {[...Array(5)].map((_, index) => (
                        <div key={index} className='bg-white p-4 rounded-lg shadow text-center flex flex-col items-center justify-center'>
                            <FaUser className="text-yellow-500 text-3xl mb-2" />
