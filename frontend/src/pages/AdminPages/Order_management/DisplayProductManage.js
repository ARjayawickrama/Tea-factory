        ...
        <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (regex.test(e.target.value)) {
                  setProductName(e.target.value); // Update state only if valid
                }
              }}
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              maxLength={100}
              onChange={(e) => {
                const regex = /^[^0-9]*$/; // Disallow numbers
                if (regex.test(e.target.value)) {
                  setDescription(e.target.value); // Update state only if no numbers
                }
              }}
              className="w-full px-3 py-2 border rounded"
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        <div className="container p-4 mx-auto">
          ...
          <div className="mt-6 Product_list">
            {" "}
            {/* Add margin-top here if needed */}
            <table className="w-full bg-white border-collapse rounded-lg shadow-lg">
              <thead>
                <tr className="w-2 font-extrabold text-white bg-green-800">
                  <th className="w-1 p-2 text-center border border-b">
                    Product Name
                  </th>
                  <th className="w-1 p-2 text-center border border-b">
                    Product Image
                  ...
                  <th className="w-1 px-4 py-3 text-center border">
                    Weights & Prices
                  </th>
                  <th className="w-1 p-2 text-center border border-b">
                    Action
