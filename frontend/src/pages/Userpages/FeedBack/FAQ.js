...
const FAQ = () => {
  ...
  const faqData = [
      ...
      },
      {
        ...
        answer: 'Certain teas,  may be safe for pregnant women, but it’s always recommended to consult with a healthcare provider before consuming herbal or caffeinated teas during pregnancy.',
      },
      {
